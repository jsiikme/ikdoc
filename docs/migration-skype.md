...
- [Chat intégré](pendant-reunion.md) et réactions
- [Partage d'écran](pendant-reunion.md) avec outils de dessin et prise de contrôle
- [Salles annexes](reunions.md) (breakout rooms)
- Intégration avec [l'agenda](integrations.md), [kDrive](integrations.md) et [kChat](integrations.md)
- **Respect de la vie privée** (aucune publicité, hébergement en Suisse)
- [Chiffrement](securite.md) AES-256
...
Pour découvrir toutes les possibilités de kMeet, consultez le [Démarrage](demarrage.md).
...
2. Connectez-vous au calendrier [ksuite.infomaniak.com/calendar](https://ksuite.infomaniak.com/calendar) puis [créez un évènement](integrations.md) le jour de votre choix.
...
Pour en savoir plus sur les appels en visioconférence sur kChat, consultez [Intégrations](integrations.md).
