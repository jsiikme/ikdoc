...
4. Autorisez l'accès à votre **webcam** et votre **microphone** lorsque le navigateur ou l'application le demande.
    ...
    ![Popup du navigateur demandant l'accès à la caméra et au micro](../../../assets/images/kmeet/demarrage-permissions.png)

5. Renseignez un **pseudonyme** ou votre nom et prénom.

    ![Écran de pré-connexion — saisie du nom et bouton pour rejoindre](../../../assets/images/kmeet/demarrage-prejoin.png)
