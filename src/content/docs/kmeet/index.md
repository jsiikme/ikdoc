...
![Page d'accueil de kMeet](../../../assets/images/kmeet/presentation-accueil.png)
...
| Enregistrement | Enregistrement vidéo côté serveur, stocké sur kDrive. |
| Streaming en direct | Diffusion publique d'une réunion via un flux séparé. |
...
- Les échanges sont **automatiquement chiffrés** (AES-256) par les serveurs Infomaniak.
- Possibilité de définir **votre propre clé de chiffrement** pour un chiffrement de bout en bout (E2E).
- Protection des réunions par **mot de passe**.
- **Salle d'attente** pour contrôler l'accès des participants.
